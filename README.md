...
[![ComfyUI compatibility](https://img.shields.io/badge/ComfyUI-0.28.x_--_0.30.x_verified-brightgreen)](https://github.com/Comfy-Org/ComfyUI/releases)
...
- Verified against `comfyui-frontend-package` **1.45 – 1.47** (ComfyUI
  **v0.28.x – v0.30.x**) — each new ComfyUI release is audited against the
