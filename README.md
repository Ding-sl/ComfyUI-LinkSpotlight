...
[![ComfyUI compatibility](https://img.shields.io/badge/ComfyUI-0.28.x_--_0.32.x_verified-brightgreen)](https://github.com/Comfy-Org/ComfyUI/releases)
...
- Verified against `comfyui-frontend-package` **1.45 – 1.48** (ComfyUI
  **v0.28.x – v0.32.x**) — each new ComfyUI release is audited against the
