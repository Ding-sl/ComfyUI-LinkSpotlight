...
[![ComfyUI compatibility](https://img.shields.io/badge/ComfyUI-0.28.x_--_0.36.x_verified-brightgreen)](https://github.com/Comfy-Org/ComfyUI/releases)
[![Frontend compatibility](https://img.shields.io/badge/comfyui--frontend--package-1.45_--_1.52_verified-brightgreen)](https://github.com/Comfy-Org/ComfyUI_frontend)
...
- Verified against `comfyui-frontend-package` **1.45 – 1.52** (ComfyUI
  **v0.28.x – v0.36.x**) — each new ComfyUI release is audited against the
